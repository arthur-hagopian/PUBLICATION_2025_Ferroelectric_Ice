...
if __name__ == '__main__':
    ...
    print('H bilayer 6 : ' + str(selected_atoms_groups[10]))
    print('O bilayer 6 : ' + str(selected_atoms_groups[11]))
    # Define for plot
    ...
    colors = ['blue', 'blue', 'red', 'red', 'green', 'green', 'orange', 'orange', 'purple', 'purple', 'pink', 'pink']
    alphas = [1.0, 0.5, 1.0, 0.5, 1.0, 0.5, 1.0, 0.5, 1.0, 0.5, 1.0, 0.5]
