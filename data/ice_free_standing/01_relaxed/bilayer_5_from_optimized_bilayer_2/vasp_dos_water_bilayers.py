...
if __name__ == '__main__':
    ...
    for o in oxygen_positions:
        ...
        o_idx += 1
    # Define groups
    selected_atoms_groups = [group_h_1, group_o_1, group_h_2, group_o_2, group_h_3, group_o_3, group_h_4, group_o_4, group_h_5, group_o_5]
    # Print to check
    ...
    print('H bilayer 3 : ' + str(selected_atoms_groups[4]))
    print('O bilayer 3 : ' + str(selected_atoms_groups[5]))
    print('H bilayer 4 : ' + str(selected_atoms_groups[6]))
    print('O bilayer 4 : ' + str(selected_atoms_groups[7]))
    print('H bilayer 5 : ' + str(selected_atoms_groups[8]))
    print('O bilayer 5 : ' + str(selected_atoms_groups[9]))
    # Define for plot
    labels = ['Bilayer 1 : H', 'Bilayer 1 : O', 'Bilayer 2 : H', 'Bilayer 2 : O', 'Bilayer 3 : H', 'Bilayer 3 : O', 'Bilayer 4 : H', 'Bilayer 4 : O', 'Bilayer 5 : H', 'Bilayer 5 : O']
    colors = ['blue', 'blue', 'red', 'red', 'green', 'green', 'orange', 'orange', 'purple', 'purple']
    alphas = [1.0, 0.5, 1.0, 0.5, 1.0, 0.5, 1.0, 0.5, 1.0, 0.5]
