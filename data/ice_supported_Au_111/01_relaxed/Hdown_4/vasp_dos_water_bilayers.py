...
if __name__ == '__main__':
    ...
    for o in oxygen_positions:
        ...
        o_idx += 1
    # Define groups
    selected_atoms_groups = [group_h_1, group_o_1, group_h_2, group_o_2, group_h_3, group_o_3, group_h_4, group_o_4]
    # Print to check
    ...
    # Define for plot
    labels = ['Bilayer 1 : H', 'Bilayer 1 : O', 'Bilayer 2 : H', 'Bilayer 2 : O', 'Bilayer 3 : H', 'Bilayer 3 : O', 'Bilayer 4 : H', 'Bilayer 4 : O']
    colors = ['blue', 'blue', 'red', 'red', 'green', 'green', 'orange', 'orange']
    alphas = [1.0, 0.5, 1.0, 0.5, 1.0, 0.5, 1.0, 0.5]
