...
if __name__ == '__main__':
    ...
    for o in oxygen_positions:
        ...
        o_idx += 1
    # Define groups
    selected_hydrogen_groups = [group_h_1,group_h_2,group_h_3,group_h_4,group_h_5,group_h_6]
    selected_oxygen_groups = [group_o_1,group_o_2,group_o_3,group_o_4,group_o_5,group_o_6]
    # Define for plot
