...
def plot_dos(energies, total_dos, projected_dos, selected_atoms_groups, labels, colors, alphas):
    ...
    atom_dos_sum_all = []
    for i,selected_atoms in enumerate(selected_atoms_groups):
        atom_dos_sum = []
...
if __name__ == '__main__':
    ...
    # Define Au atoms groups
    group_au = [] 
    au_idx = 1
    for au in gold_positions:
        group_au.append(au_idx)
        au_idx += 1
    ...
    for o in oxygen_positions:
        ...
        o_idx += 1
    # Define groups
    selected_atoms_groups = [group_au, group_h_1, group_o_1]
    # Print to check
    print('Au : ' + str(selected_atoms_groups[0]))
    print('H bilayer 1 : ' + str(selected_atoms_groups[1]))
    print('O bilayer 1 : ' + str(selected_atoms_groups[2]))
    # Define for plot
    labels = ['Au', 'Bilayer 1 : H', 'Bilayer 1 : O']
